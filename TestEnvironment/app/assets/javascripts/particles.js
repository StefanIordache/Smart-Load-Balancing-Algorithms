...
function startLoadingScreenAnimation() {
    $( "#loading-screen-animation" ).fadeIn( "slow", function() {});
    loadAnimation();
    configAfterLoad();
}
...
function loadAnimation() {
    ...
    function resize(e) {
        if ($(".page-wrapper").hasClass("toggled")) {
            screenWidth = canvas.width = document.documentElement.clientWidth - $("#sidebar").width();
            console.log(screenWidth);
        } else {
            screenWidth = canvas.width = document.documentElement.clientWidth;
            console.log(screenWidth);
        }
        screenHeight = canvas.height = document.documentElement.scrollHeight;
    ...
    function mouseDown(e) {
        ...
        if ($(".page-wrapper").hasClass("toggled")) {
            gravities.push(new GravityPoint(e.clientX - $("#sidebar").width(), e.clientY, G_POINT_RADIUS, {
                particles: particles,
                gravities: gravities
            }));
        } else {
...
function configAfterLoad() {
    $(".dg").css('z-index', 99);
}

function stopLoadingScreenAnimation() {
    $( "#loading-screen-animation" ).fadeOut( "slow", function() {
        $(".dg").css('display', 'none');
        $("#loading-screen-animation").css('display', 'none');
    });
